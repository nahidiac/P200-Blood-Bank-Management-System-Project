...
public class AddDonorPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -3, 1200, 670));
    ...
    public String isDataValid() {
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd"); 
        String dateOfBirth = dateFormat.format(dateOfBirthField.getDate()).trim(); 
